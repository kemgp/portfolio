    ...
    return (
        <div className="">
            <div className="relative w-full h-screen bg-black overflow-hidden mx-auto py-10">
                ...
                <div className="absolute top-2/5 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 text-white gap-12 flex flex-col items-center justify-center mt-16">
                    ...
                    <div>
                        <h1 className="text-4xl text-center text-white font-light">Let's turn your <span className="text-gray-400">complex ideas </span>into fluid<span className="text-gray-400"> reality.</span></h1>
